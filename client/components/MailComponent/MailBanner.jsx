  ...
  return (
    <section className="w-full h-[100vh]  lg:h-[65vh] flex flex-col items-center bg-white">
      <div className="w-full flex flex-col items-center my-4 lg:my-10">
        <h1 className="text-3xl font-bold mx-auto mb-2 text-[#00AEFF]">
          How it works
        </h1>
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="w-full flex flex-col items-center my-4">
          <FaHandshake size={65} className="text-[#FFDC00]" />
          <h2 className="text-2xl font-bold mx-auto mb-2  text-[#00AEFF]">
            Find an event
          </h2>
          <p className="text-center mx-auto w-9/12">
        ...
        <div className="w-full flex flex-col items-center my-4">
          <BsFillCalendarDayFill size={55} className="mb-2 text-[#FFDC00]" />
          <h1 className="text-2xl font-bold mx-auto my-2 text-[#00AEFF]">
            Create an event
          </h1>
          <p className="text-center mx-auto w-9/12">
        ...
        <div className="w-full flex flex-col items-center my-4">
          <IoIosPeople size={65} className="mb-2 text-[#FFDC00]" />
          <h1 className="text-2xl font-bold mx-auto mb-2 text-[#00AEFF]">
